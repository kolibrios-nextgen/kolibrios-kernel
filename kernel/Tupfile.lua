...
tup.rule("echo __REV = 0x`git rev-parse --short HEAD` > %o", {"rev.inc"})
tup.rule({"bootbios.asm", extra_inputs = {"lang.inc", "rev.inc"}}, "fasm %f %o ", "bootbios.bin")
tup.rule({"bootbios.asm", extra_inputs = {"lang.inc", "rev.inc"}}, "fasm %f %o -dextended_primary_loader=1", "bootbios.bin.ext_loader")
tup.rule({"bootbios.asm", extra_inputs = {"lang.inc", "rev.inc"}}, "fasm %f %o -dpretest_build=1", "bootbios.bin.pretest")
